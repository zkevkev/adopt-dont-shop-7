...
RSpec.describe "the veterinarian update" do
  it "shows the veterinarian edit form" do
    admin = Admin.create
    shelter = admin.shelters.create(name: "Hollywood shelter", city: "Irvine, CA", foster_program: false, rank: 7)
  ...
  context "given valid data" do
    it "submits the edit form and updates the veterinarian" do
      admin = Admin.create
      shelter = admin.shelters.create(name: "Heavenly pets", city: "Aurora, CO", foster_program: true, rank: 7)
  ...
  context "given invalid data" do
    it "re-renders the edit form" do
      admin = Admin.create
      shelter = admin.shelters.create(name: "Heavenly pets", city: "Aurora, CO", foster_program: false, rank: 7)
